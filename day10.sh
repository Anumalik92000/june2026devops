...
resource "aws_route_table" "PathnexRT" {
    ...
    route {
        ...
        gateway_id = aws_internet_gateway.PthnexIGW.id
        }
...
## Jenkins Pipeline- Cache Maven Dependencies- learn how to reuse dependencies to speed up build
...
## GitLab CI -Cache Dependencies- to learn how to CAche Dependencies in Gitlab CI
